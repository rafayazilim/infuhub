...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none data-[state=open]:bg-[#e3447c]/18 data-[state=open]:text-foreground focus:bg-[#e3447c]/18 focus:text-foreground dark:data-[state=open]:bg-[#e3447c]/28 dark:focus:bg-[#e3447c]/28",
      className,
    )}
    {...props}
  />
